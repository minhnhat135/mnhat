...
def encrypt_card_data_450(card, month, year, cvc, adyen_key, stripe_key=None, domain=None):
    ...
    referrer = f"https://checkoutshopper-live.adyen.com/checkoutshopper/securedfields/{stripe_key}/4.5.0/securedFields.html?type=card&d={domain_b64}"
    ...
    adyen_encryptor = AdyenV4_5_0(adyen_key)
